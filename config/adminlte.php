    ...
    */
    ...
    'menu' => [
        ...
        [
            'text' => 'Antrian Poli',
            'url' => '#',
            'icon' => 'fas fa-fw fa-list-ol text-info',
        ],
        [
            'text' => 'Monitor Antrian',
            'url' => '#',
            'icon' => 'fas fa-fw fa-tv text-primary',
        ],
        [
            'text' => 'Status Pelayanan',
            'url' => '#',
            'icon' => 'fas fa-fw fa-stethoscope text-danger',
        ],
        [
            'text' => 'Rekam Medis',
            'url' => '#',
            'icon' => 'fas fa-fw fa-file-medical text-success',
        ],
        ...
        [
            'text' => 'Laporan Harian',
            'route' => 'reports.index',
            'icon' => 'fas fa-fw fa-chart-line text-success',
        ],
        [
            'text' => 'Statistik Kunjungan',
            'url' => '#',
            'icon' => 'fas fa-fw fa-chart-bar text-info',
        ],
        [
            'text' => 'Analisis Penyakit',
            'url' => '#',
            'icon' => 'fas fa-fw fa-chart-pie text-warning',
        ],
        [
            'text' => 'Laporan Dokter',
            'url' => '#',
            'icon' => 'fas fa-fw fa-file-medical-alt text-primary',
        ],

        // FARMASI & LAB
        ['header' => 'FARMASI & LABORATORIUM'],

        [
            'text' => 'Manajemen Obat',
            'url' => '#',
            'icon' => 'fas fa-fw fa-pills text-danger',
        ],
        [
            'text' => 'Resep Dokter',
            'url' => '#',
            'icon' => 'fas fa-fw fa-prescription text-success',
        ],
        [
            'text' => 'Hasil Lab',
            'url' => '#',
            'icon' => 'fas fa-fw fa-microscope text-info',
        ],

        // ADMINISTRASI
        ['header' => 'ADMINISTRASI SISTEM', 'can' => 'admin-access'],

        [
            'text' => 'Manajemen User',
            'route' => 'users.index',
            'icon' => 'fas fa-fw fa-users-cog text-secondary',
            'can' => 'admin-access',
        ],
        [
            'text' => 'Konfigurasi Sistem',
            'route' => 'settings.index',
            'icon' => 'fas fa-fw fa-cogs text-info',
            'can' => 'admin-access',
        ],
        [
            'text' => 'Backup & Restore',
            'url' => '#',
            'icon' => 'fas fa-fw fa-database text-warning',
            'can' => 'admin-access',
        ],
        [
            'text' => 'Log Aktivitas',
            'url' => '#',
            'icon' => 'fas fa-fw fa-history text-primary',
            'can' => 'admin-access',
        ],
        ...
        [
            'text' => 'Profil Saya',
            'route' => 'profile.index',
            'icon' => 'fas fa-fw fa-user-circle text-info',
        ],
        [
            'text' => 'Keamanan Akun',
            'route' => 'profile.change-password',
            'icon' => 'fas fa-fw fa-shield-alt text-success',
        ],
        [
            'text' => 'Keluar Sistem',
            'route' => 'logout',
