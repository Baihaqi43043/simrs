        ...
        <div class="col-md-8">
            ...
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">
                        <i class="fas fa-plus"></i> Form Tambah Poli
                    </h3>
                </div>

                <form action="{{ route('polis.store') }}" method="POST" id="poliForm">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('deskripsi') is-invalid @enderror"
                                      ...
                                      name="deskripsi"
                                      rows="4"
                                      placeholder="Deskripsi atau keterangan poli (opsional)">{{ old('deskripsi') }}</textarea>
                            @error('deskripsi')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
            ...
            <div class="card card-info">
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-warning mt-3">
                        ...
                        Pastikan kode poli belum digunakan sebelumnya.
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="preview-content">
                        ...
                        <div class="mb-2">
                            ...
                            <span id="preview-deskripsi" class="text-muted">-</span>
                        </div>
                        <div class="mb-2">
    ...
    $('#poliForm').on('submit', function(e) {
        ...
        if (!kode || !nama) {
            ...
            Swal.fire({
                icon: 'error',
                title: 'Oops...',
                text: 'Kode poli dan nama poli harus diisi!'
            });
            return false;
        }
