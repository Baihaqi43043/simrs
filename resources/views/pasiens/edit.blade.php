                ...
                <form action="{{ route('pasiens.update', $pasien->id) }}" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <div class="alert alert-info">
                            ...
                            Nomor RM: <strong>{{ $pasien->no_rm }}</strong> (tidak dapat diubah)
                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('no_telepon_darurat') is-invalid @enderror"
                                                   ...
                                                   value="{{ old('no_telepon_darurat', $pasien->no_telepon_darurat) }}">
                    ...
                    <div class="card-footer">
                        <div class="row">
                            ...
                            <div class="col-md-6 text-right">
                                <a href="{{ route('pasiens.show', $pasien->id) }}" class="btn btn-info mr-2">
